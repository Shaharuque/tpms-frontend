...
const PatientInformation = () => {
  ...
  // const x = Object.keys(patient_details);
  ...
  //   defaultValues: {
  //     first_name: patient_details?.client_first_name || undefined,
  //     middle_name: patient_details?.client_middle || undefined,
  //     last_name: patient_details?.client_last_name  || undefined,
  //     dob: patient_details?.client_dob || undefined,
  //     email: patient_details?.email || undefined,
  //     phone: patient_details?.phone_number || undefined,
  //     gender: patient_details?.client_gender || undefined,
  //   }
  // });
  ...
  return (
    ...
    <>
    {
      loading ? <Loading></Loading> : <Test options={options} patient_details={patient_details} />
    }
    </>
  );
};
