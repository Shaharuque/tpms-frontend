...
export default function CredenTial() {
  return (
    <div>
      {" "}
      <div className="p-2">
        <h4 className="text-md mt-2 text-left text-orange-400 mb-4">
          Credentials
        </h4>
        <button
          type="submit"
                  ...
                  <table class="min-w-full">
                    <thead class="border  bg-gradient-to-r from-secondary to-primary  hover:to-secondary ">
                      <tr>
                        <th
                          scope="col"
                          class="border text-sm font-medium text-white px-6 py-1 text-left"
                        >
                          Name
                        </th>
                        <th
                        ...
                        <th
                          scope="col"
                          class="border text-sm text-white font-medium  px-6 py-1 text-left"
                        >
                          File
                        </th>
                      </tr>
