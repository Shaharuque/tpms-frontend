...
const CancelledSession = () => {
  const [CancelledSessionInfoData, SetCancelledSessionInfoData] = useState([]);
  ...
  useEffect(() => {
    axios("../../All_Fake_Api/LastWeekDeposit.json")
      .then((response) => {
        SetCancelledSessionInfoData(response?.data);
      })
      .catch((error) => {
        console.log(error);
      });
  }, []);
  console.log(CancelledSessionInfoData);
      ...
      <div className="my-2">
        ...
        <div className=" overflow-scroll pt-3">
          <Table
            ...
            columns={columns}
            dataSource={CancelledSessionInfoData} //Which data chunk you want to show in table
