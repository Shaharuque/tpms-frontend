...
import { useProviderPatientAddDocuemntsMutation } from "../../../../../../features/ProviderPortal/PatientDocument_redux/patientDocumentApi";
...
const AddDocuments = ({ handleClose, open }) => {
  ...
  const [providerPatientAddDocuemnts, { data, isSuccess, isError }] = useProviderPatientAddDocuemntsMutation();
  ...
  const onSubmit = (data) => {
    ...
    providerPatientAddDocuemnts({ token, payload });
    reset();
  };
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className=" grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 my-3 mr-2 gap-x-2 gap-y-1">
              <div>
                ...
                <input type="text" name="description" className="modal-input-field ml-1 w-full" {...register("description")} />
              </div>
              ...
              <div>
                ...
                <input type="file" className=" py-[5px] mx-1 text-xs w-full" {...register("fileName")} />
              </div>
            </div>
            <div className="bg-gray-200 py-[1px] mt-3"></div>
