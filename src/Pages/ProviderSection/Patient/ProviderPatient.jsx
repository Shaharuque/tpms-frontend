...
import { baseIp, headers, providerIp } from "../../../Misc/BaseClient";
...
const ProviderPatient = () => {
  ...
  useEffect(() => {
    const getPatientsData = async () => {
      let res = await axios({
        method: "post",
        url: `${providerIp}/patients/get/all`,
        headers: {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, { id, is_active_client }) => {
        ...
        return <div className="flex justify-center">{/* <PatientStatusAction id={id} is_active_client={is_active_client}></PatientStatusAction> */}</div>;
      },
    },
  ];
  return (
