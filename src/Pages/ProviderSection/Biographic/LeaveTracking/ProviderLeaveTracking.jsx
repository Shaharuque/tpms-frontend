...
import ProviderLeaveTrackingAdd from "./ProviderLeaveTrackingAdd";
import {
  useProviderDeleteLeaveTrackingMutation,
  useProvidergetLeaveTrackingQuery,
} from "../../../../features/ProviderPortal/ProviderLeaveTracking_redux/ProviderLeaveTrackingApi";
import useToken from "../../../../CustomHooks/useToken";

const ProviderLeaveTracking = () => {
  ...
  const { data: leaveTrackData, isLoading: getleaveTrackLoading } = useProvidergetLeaveTrackingQuery({
    token,
    payload: {
      employee_id: id,
    },
  ...
  return (
    <div className="h-[100vh]">
      ...
      {openEditModal && <ProviderLeaveTrackingAdd handleClose={handleClose} open={openEditModal}></ProviderLeaveTrackingAdd>}
    </div>
  );
};

export default ProviderLeaveTracking;
