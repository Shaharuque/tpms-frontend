...
import { useProvideraddLeaveTrackingMutation } from "../../../../features/ProviderPortal/ProviderLeaveTracking_redux/ProviderLeaveTrackingApi";

const ProviderLeaveTrackingAdd = ({ handleClose, open }) => {
  const { register, handleSubmit, reset } = useForm();
  const { token } = useToken();
  const { id } = useParams();

  // Add new leave api
  const [addLeaveTracking, { data: addleaveTrackdata, isSuccess: addleaveTrackSuccess, isError: addleaveTrackError }] = useProvideraddLeaveTrackingMutation();
...
export default ProviderLeaveTrackingAdd;
