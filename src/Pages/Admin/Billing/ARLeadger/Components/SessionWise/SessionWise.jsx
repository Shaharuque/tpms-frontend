...
const SessionWise = () => {
  ...
  const [bulkNoteSave, { data: bulkNoteData, isSuccess: bulkNoteSucceed }] =
    useBulkNoteSaveMutation();
  console.log(bulkNoteData);
  useEffect(() => {
    if (bulkNoteSucceed === true) {
      sethasMore(true);
      setpage(2);
    }
  }, [bulkNoteSucceed]);
  ...
  }, [token, formData, bulkNoteSucceed]);
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Payor Escalation">
                          Payor Escalation
                        </option>
                        <option value="Provider Escalation">
                          Provider Escalation
                        </option>
                        ...
                        <option value="Sent to posting team">
                        ...
                        <option value="Lack of information">
                          Lack of information
                        </option>
