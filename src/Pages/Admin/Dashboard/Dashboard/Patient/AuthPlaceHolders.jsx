...
const AuthPlaceHolders = () => {
  ...
  console.log(AuthPlaceHoldersData);
  ...
  const columns = [
    ...
    },
    {
      ...
      //   },
      // ],
      filteredValue: filteredInfo.authorization || null,
      onFilter: (value, record) => record.authorization.includes(value),
      sorter: (a, b) => {
        return a.authorization > b.authorization ? -1 : 1;
      },
      sortOrder:
        sortedInfo.columnKey === "authorization" ? sortedInfo.order : null,

      // render contains what we want to reflect as our data
      // authorization, id, key=>each row data(object) property value can be accessed.
      render: (_, { authorization, id, key }) => {
        //console.log("tags : ", client_first_name, id, key);
        return (
          <div>
            <h1>{authorization}</h1>
  ...
  return (
    <div className={!AuthPlaceHoldersData ? "h-[100vh]" : ""}>
