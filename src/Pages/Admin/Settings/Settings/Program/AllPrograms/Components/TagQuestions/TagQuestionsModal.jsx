...
import TagQuestionsTable from "./TagQuestionsTable";

const TagQuestionsModal = ({ open, handleTagQuestionClose }) => {
  return (
    <div>
      <Modal
        open={open}
        ...
        <div className="p-2">
          <div className="flex items-center justify-between">
            ...
            <IoCloseCircleOutline
              onClick={handleTagQuestionClose}
          ...
          <form>
            ...
            <div>
              <TagQuestionsTable></TagQuestionsTable>
            </div>
            <div className="bg-gray-200 py-[1px] mt-3"></div>
...
export default TagQuestionsModal;
