...
import ProgramCategoryAdd from "./Components/ProgramCategoryAdd";
import ProgramCategoryEdit from "./Components/ProgramCategoryEdit";
...
const ProgramCategory = () => {
  ...
  return (
    <div className="p-2 ">
      <h1 className="text-lg my-2 text-orange-400">Program Category</h1>
      ...
      <div className="2xl:w-[50%] lg:w-[70%] md:w-[100%] sm:w-[100%]">
        <div className="flex items-end justify-end my-5 mr-2">
          ...
          >
            <HiPlus className=" text-white " /> Program Category
          </button>
        </div>
