...
const NameLocationTable = ({ time, box33Open, handleTableOpen, box_no_33 }) => {
  ...
  const [emailReminder, setEmailReminder] = useState(BoolConverter(box_no_33?.email_reminder));
  ...
  const convertdatabasetime = (x) => {
    // const timeStr = x;
    // const now = moment();
    // const dateStr = now.format("YYYY-MM-DD");
    // const dateTimeStr = dateStr + " " + timeStr + ":00";
    // const dateTime = moment(dateTimeStr, "YYYY-MM-DD HH:mm:ss");
    // console.log("dateTime change", dateTime.toString());
    // return dateTime.format("YYYY-MM-DD HH:mm:ss");

    // old code
    const timeStr = x;
    const dateTimeStr = "2023-05-08T" + timeStr + ":00.000Z";
  ...
  const onSubmit = async (data) => {
    ...
    const payload = {
      ...
      // mon_start_time: convertdatabasetime(data?.mon_start_time),
      // sat_end: convertdatabasetime(data?.sat_end),
      // sat_start: convertdatabasetime(data?.sat_start),
      // sun_end: data?.sun_end,
      // sun_start: data?.sun_start,
      // mon_end_time: data?.mon_end_time,
      // mon_start_time: data?.mon_start_time,
      // thur_end: data?.thur_end,
      // thur_start: data?.thur_start,
      // tus_end: data?.tus_end,
      // tus_start: data?.tus_start,
  ...
  useEffect(() => {
    setTimeout(() => {
      reset({
        // test
        // mon_start_time: moment(time[0]?.mon_start_time).format("HH:mm"),
  ...
  // console.log("moment time ", moment("2023-05-08T04:49:05.000Z").format("HH:mm:ss"));

  return (
    <div>
      {/* Child 33  */}
      <h2 onClick={handleTableOpen} className=" mt-4 text-xs p-2 text-white bg-secondary">
        Box No 33
      </h2>
      {box33Open && (
        <div className="border">
          ...
          >
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className=" grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 my-5 mr-2 gap-6">
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">Facility Name</span>
                  </label>
                  <input
                    type="text"
                    name="facility_name"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">Address</span>
                  </label>
                  <input
                    type="text"
                    name="address"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">Address 2</span>
                  </label>
                  <input
                    type="text"
                    name="address_two"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">City</span>
                  </label>
                  <input
                    type="text"
                    name="city"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">State</span>
                  </label>
                  <select className="input-border text-gray-600 rounded-sm  text-[14px] font-medium ml-1  w-full focus:outline-none" {...register("state")}>
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">Zip</span>
                  </label>
                  <input
                    type="number"
                    name="zip"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">Phone 1</span>
                  </label>
                  <input
                    type="text"
                    name="phone_one"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">Short Code</span>
                  </label>
                  <input
                    type="text"
                    name="short_code"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">Email</span>
                  </label>
                  <input
                    type="text"
                    name="email"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">EIN</span>
                  </label>
                  <input
                    type="text"
                    name="ein"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">NPI</span>
                  </label>
                  <input
                    type="text"
                    name="npi"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">Taxonomy</span>
                  </label>
                  <input
                    type="text"
                    name="taxonomy_code"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">Contact Person</span>
                  </label>
                  <input
                    type="text"
                    name="contact_person"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">Service Area Miles</span>
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">SFTP Username</span>
                  </label>
                  <input
                    type="text"
                    placeholder="demo"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">SFTP Password</span>
                  </label>
                  <input
                    type="password"
                    name="ftp_password"
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">Default POS</span>
                  </label>
                  <select
                ...
                <div>
                  <label className="label">
                    <span className="label-text text-[16px] font-medium text-[#9b9b9b] text-left">Default Timezone:</span>
                  </label>
                  <select className="input-border text-gray-600 rounded-sm  text-[14px] font-medium ml-1  w-full focus:outline-none" {...register("timezone")}>
                    ...
                    <option value="Europe/Volgograd">(UTC/GMT +04:00) Europe/Volgograd</option>
                ...
                <div className=" xl:mt-10 2xl:mt-5 items-start">
                  <div>
                    <Switch checked={isCombo} onChange={() => setIsCombo(!isCombo)} size="small" />
                    <span className="text-[14px]  font-medium text-gray-500 mx-3">Combo Code</span>
                  </div>
                </div>
                <div className=" xl:mt-10 2xl:mt-5 items-start">
                  <div>
                    <Switch checked={emailReminder} onChange={() => setEmailReminder(!emailReminder)} size="small" />
                    <span className="text-[14px]  font-medium text-gray-500 mx-3">Email Reminders</span>
                  </div>
                </div>
                {/* done  */}
              </div>
                ...
                <div>
                  ...
                  <div className=" my-5 mr-2 gap-5">
                    <div className="flex flex-wrap items-center my-1 gap-2">
                      <h5 className="text-sm text-gray-600 w-[70px] mr-5 md:mr-0">Monday</h5>
                      <input
                        type="time"
                        // name="timeField"
                        // name="mon_start_time"
                        // defaultValue={moment(time[0]?.mon_start_time).format("HH:mm")}
                        format="h:mm"
                      ...
                      <input type="time" name="mon_end_time" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("mon_end_time")} />
                      <span className="text-sm ">
                        <FiPlusCircle className="text-secondary" />
                      </span>
                    </div>
                    <div className="flex flex-wrap items-center my-1 gap-2">
                      <h5 className="text-sm text-gray-600 w-[70px] mr-5 md:mr-0">Tuesday</h5>
                      <input type="time" name="tus_start" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("tus_start")} />
                      <span className="text-sm text-gray-600">to</span>
                      <input type="time" name="tus_end" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("tus_end")} />
                      <span className="text-sm ">
                        <FiPlusCircle className="text-secondary" />
                      </span>
                    </div>
                    <div className="flex flex-wrap items-center my-1 gap-2">
                      <h5 className="text-sm text-gray-600 w-[70px] mr-5 md:mr-0">Wednesday</h5>
                      <input type="time" name="wed_start" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("wed_start")} />

                      <span className="text-sm text-gray-600">to</span>
                      <input type="time" name="wed_end" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("wed_end")} />
                      <span className="text-sm ">
                        <FiPlusCircle className="text-secondary" />
                      </span>
                    </div>
                    <div className="flex flex-wrap items-center my-1 gap-2">
                      <h5 className="text-sm text-gray-600 w-[70px] mr-5 md:mr-0">Thursday</h5>
                      <input
                        type="time"
                        name="thur_start"
                      ...
                      <span className="text-sm text-gray-600">to</span>
                      <input type="time" name="thur_end" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("thur_end")} />
                      <span className="text-sm ">
                        <FiPlusCircle className="text-secondary" />
                      </span>
                    </div>
                    <div className="flex flex-wrap items-center my-1 gap-2">
                      <h5 className="text-sm text-gray-600 w-[70px] mr-5 md:mr-0">Friday</h5>
                      <input type="time" name="fri_start" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("fri_start")} />

                      <span className="text-sm text-gray-600">to</span>
                      <input type="time" name="fri_end" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("fri_end")} />
                      <span className="text-sm ">
                        <FiPlusCircle className="text-secondary" />
                      </span>
                    </div>
                    <div className="flex flex-wrap items-center my-1 gap-2">
                      <h5 className="text-sm text-gray-600 w-[70px] mr-5 md:mr-0">Saturday</h5>
                      <input type="time" name="sat_start" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("sat_start")} />

                      <span className="text-sm text-gray-600">to</span>
                      <input type="time" name="sat_end" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("sat_end")} />
                      <span className="text-sm ">
                        <FiPlusCircle className="text-secondary" />
                      </span>
                    </div>
                    <div className="flex flex-wrap items-center my-1 gap-2">
                      <h5 className="text-sm text-gray-600 w-[70px] mr-5 md:mr-0">Sunday</h5>
                      <input type="time" name="sun_start" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("sun_start")} />

                      <span className="text-sm text-gray-600">to</span>
                      <input type="time" name="sun_end" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("sun_end")} />
                      <span className="text-sm ">
                        <FiPlusCircle className="text-secondary" />
                      </span>
                    </div>
              ...
              <div className="mt-2">
                {/* submit  */}
                <input className="pms-button mb-3" type="submit" value={"Save Facility"} />
...
//   console.log("settings data in another component", data);
...
//   const datetime12 = (x) => {
//     const datetime = moment(x);
//     const time12 = datetime.format("hh:mm");
//     console.log(time12);
//     return time12;
//   };
...
//       wed_end: data?.wed_end,
//       wed_start: data?.wed_start,
//       fri_start: data?.fri_start,
//       fri_end: data?.fri_end,
//     };
...
//     setTimeout(() => {
//       reset({
//         mon_start_time: datetime12(time[0]?.mon_start_time),
//         // mon_start_time: extractTime(time[0]?.mon_start_time),
//         mon_end_time: datetime12(time[0]?.mon_end_time),
//         tus_start: datetime12(time[0]?.tus_start),
//         tus_end: datetime12(time[0]?.tus_end),
//         wed_start: datetime12(time[0]?.wed_start),
//         wed_end: datetime12(time[0]?.wed_end),
//         thur_start: datetime12(time[0]?.thur_start),
//         thur_end: datetime12(time[0]?.thur_end),
//         fri_start: datetime12(time[0]?.fri_start),
//         fri_end: datetime12(time[0]?.fri_end),
//         sat_start: datetime12(time[0]?.sat_start),
//         sat_end: datetime12(time[0]?.sat_end),
//         sun_start: datetime12(time[0]?.sun_start),
//         sun_end: datetime12(time[0]?.sun_end),
//       });
//     }, 100);
//   }, [reset, time]);
...
//                     <div className="flex flex-wrap items-center my-1 gap-2">
//                       <h5 className="text-sm text-gray-600 w-[70px] mr-5 md:mr-0">Tuesday</h5>
//                       <input type="time" format="h:mm" name="tus_start" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("tus_start")} />
//                       <span className="text-sm text-gray-600">to</span>
//                       <input type="time" format="h:mm" name="tus_end" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("tus_end")} />
//                       <span className="text-sm ">
//                         <FiPlusCircle className="text-secondary" />
//                       </span>
//                     </div>
//                     <div className="flex flex-wrap items-center my-1 gap-2">
//                       <h5 className="text-sm text-gray-600 w-[70px] mr-5 md:mr-0">Wednesday</h5>
//                       <input type="time" format="h:mm" name="wed_start" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("wed_start")} />

//                       <span className="text-sm text-gray-600">to</span>
//                       <input type="time" format="h:mm" name="wed_end" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("wed_end")} />
//                       <span className="text-sm ">
//                         <FiPlusCircle className="text-secondary" />
//                       </span>
//                     </div>
...
//                       <span className="text-sm text-gray-600">to</span>
//                       <input type="time" name="thur_end" format="h:mm" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("thur_end")} />
//                       <span className="text-sm ">
//                         <FiPlusCircle className="text-secondary" />
//                       </span>
//                     </div>
//                     <div className="flex flex-wrap items-center my-1 gap-2">
//                       <h5 className="text-sm text-gray-600 w-[70px] mr-5 md:mr-0">Friday</h5>
//                       <input type="time" name="fri_start" format="h:mm" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("fri_start")} />

//                       <span className="text-sm text-gray-600">to</span>
//                       <input type="time" name="fri_end" format="h:mm" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("fri_end")} />
//                       <span className="text-sm ">
//                         <FiPlusCircle className="text-secondary" />
//                       </span>
//                     </div>
//                     <div className="flex flex-wrap items-center my-1 gap-2">
//                       <h5 className="text-sm text-gray-600 w-[70px] mr-5 md:mr-0">Saturday</h5>
//                       <input type="time" name="sat_start" format="h:mm" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("sat_start")} />

//                       <span className="text-sm text-gray-600">to</span>
//                       <input type="time" name="sat_end" format="h:mm" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("sat_end")} />
//                       <span className="text-sm ">
//                         <FiPlusCircle className="text-secondary" />
//                       </span>
//                     </div>
//                     <div className="flex flex-wrap items-center my-1 gap-2">
//                       <h5 className="text-sm text-gray-600 w-[70px] mr-5 md:mr-0">Sunday</h5>
//                       <input type="time" name="sun_start" format="h:mm" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("sun_start")} />

//                       <span className="text-sm text-gray-600">to</span>
//                       <input type="time" format="h:mm" name="sun_end" className="border rounded-sm px-2 py-[5px] mx-1 text-xs " {...register("sun_end")} />
//                       <span className="text-sm ">
//                         <FiPlusCircle className="text-secondary" />
//                       </span>
//                     </div>
