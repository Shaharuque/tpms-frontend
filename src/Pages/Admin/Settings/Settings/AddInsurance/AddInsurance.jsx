...
const AddInsurance = () => {
    ...
    // testing spaceee............
    useEffect(() => {
        axios("../../../All_Fake_Api/Transfer.json").then((response) => { // console.log("chkd ata", response?.data)
              ...
              {optionNames.map((name) => (
                <option key={name} value={name} className="text-sm font-normal">
                  {name}
                    ...
                    >
                        {
                        TransferData.length > 0 && TransferData.map((item, index) => (
                ...
                <option key={name} value={name} className="text-sm font-normal">
                  {name}
                    ...
                    >
                        ...
                        selectedKeys.length > 0 && selectedKeys.map((item, index) => (
                            <option>{
                                item.title
                            }</option>
                        ))
                ...
                <form onSubmit={
                    ...
                    <div className=" grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 my-3 mr-2 gap-x-2 gap-y-1">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" className="border rounded-sm px-2 py-[5px] mx-1 text-xs w-full" {...register("name")}/>
                        </div>
                        {/* Address  */}
                        <div>
                            <label className="label">
                            ...
                            <input type="text" name="Address" className="border rounded-sm px-2 py-[5px] mx-1 text-xs w-full" {...register("Address")}/>
                        </div>
                        {/* Address  */}
                        <div>
                            <label className="label">
                            ...
                            <input type="text" name="city" className="border rounded-sm px-2 py-[5px] mx-1 text-xs w-full" {...register("city")}/>
                        </div>
                        <div>
                            <label className="label">
                                <span className="label-text text-xs text-gray-600 text-left">
                            ...
                            <div>
                                <select className="border rounded-sm px-2 py-[3px] font-thin mx-1 text-xs w-full" {...register("state")}>
                        ...
                        <div>
                            ...
                            <input type="text" name="zip" className="border rounded-sm px-2 py-[5px] mx-1 text-xs w-full" {...register("zip")}/>
                        </div>
                        {/* Address  */}
                        <div>
                            <label className="label">
                            ...
                            <input type="text" name="contract1" className="border rounded-sm px-2 py-[5px] mx-1 text-xs w-full" {...register("contract1")}/>
                        </div>
                        <div>
                            <label className="label">
                                <span className="label-text text-xs text-gray-600 text-left">
                            ...
                            <input type="text" name="contract2" className="border rounded-sm px-2 py-[5px] mx-1 text-xs w-full" {...register("contract2")}/>
                        </div>
                        {/* Address  */}
                        <div>
                            <label className="label">
                            ...
                            <input type="text" name="phone1" className="border rounded-sm px-2 py-[5px] mx-1 text-xs w-full" {...register("phone1")}/>
                        </div>
                        <div>
                            <label className="label">
                                <span className="label-text text-xs text-gray-600 text-left">
                            ...
                            <input type="text" name="phone2" className="border rounded-sm px-2 py-[5px] mx-1 text-xs w-full" {...register("phone2")}/>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="billing observation" className="border rounded-sm px-2 py-[5px] mx-1 text-xs w-full" {...register("billing_observation")}/>
                        </div>
                        <div>
                            <label className="label">
                                <span className="label-text text-xs text-gray-600 text-left">
                            ...
                            <input type="text" name="Electronic_" className="border rounded-sm px-2 py-[5px] mx-1 text-xs w-full" {...register("phone2")}/>
                        </div>
                    </div>
