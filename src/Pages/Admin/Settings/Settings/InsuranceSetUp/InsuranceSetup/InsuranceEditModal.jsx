...
export default function InsuranceEditModal({ handleClose, open, row }) {
          ...
          <div className="border p-5">
            ...
            >
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 my-5 1D-2 gap-5">
                  {/* name  */}
                  <div>
                    {" "}
                ...
                {/* submit  */}
                <div className="modal-action my-4">
                  {/* <input type="submit" /> */}
                  <input
                    type="submit"
                    value={"SAVE"}
