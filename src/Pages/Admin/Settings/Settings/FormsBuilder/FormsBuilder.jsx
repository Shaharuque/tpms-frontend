...
const FormsBuilder = () => {
    ...
    useEffect(() => { // $(fb.current).formBuilder({ formData });
    ...
    return (
      ...
      <div className='flex-none w-16 h-14'> <button onClick={showdata}>Show data</button></div>
            ...
            <div className="inline-flex float-right mt-4 mx-5">
                <button className="btn  mx-5 btn-xs sm:btn-sm md:btn-md lg:btn-lg btnstyle"
                    onClick={cleardata}>Clear</button>
                <button className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg btnstyle"
                    onClick={showdata}>Show data</button>
