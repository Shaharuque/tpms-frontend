  ...
  return (
    <div>
      <div>
        ...
        {openTable && (
          <>
            <div className="px-4  py-3 mt-5 mb-1 mx-2 flex items-center justify-between rounded-md text-red-600 font-normal text-xs red-box">
              <p>
                <span className="font-semibold"> ALERT ! </span> No Files found.
              </p>
            </div>
