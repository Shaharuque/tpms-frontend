    ...
    <div>
      <div className="form-border 2xl:w-[70%] w-full mx-auto p-5 bg-white">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            <div>
              <div className="flex  flex-row justify-between flex-wrap mb-24">
            ...
            <div>
              ...
              <div className="mt-3 mb-8 border-blue-600 border-2">
                <TextArea
                  ...
                  maxLength={300}
                  rows={5}
                  placeholder="Enter Test Administered"
                  size="large"
                  className=""
            ...
            <div>
              <h1 className="form-inner-head my-2 mb-8">SCORES:</h1>
            ...
            <div>
              ...
              <div className="mt-3 border-blue-600 border-2">
                <TextArea
                  ...
                  size="large"
                  className=""
                  {...register("implication_of_testing")}
                />
              </div>
            </div>
            <div>
