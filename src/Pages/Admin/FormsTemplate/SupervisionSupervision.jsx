      ...
      <div className="form-border 2xl:w-[70%] w-full mx-auto p-5 ">
        <div>
          ...
          <div className="form-title mb-5">
            <h1>
              SUPERVISION NON-BILLABLE <br />
              SUPERVISION: REGISTERED BEHAVIOR TECHNICIAN
            </h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            ...
            <div>
              {" "}
              <span className="form-inner-head ">PARENT TRAINING PROVIDED:</span>
...
export default SupervisionSupervision;
