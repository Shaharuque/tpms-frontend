    ...
    <div className="sm:h-[100vh]">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 my-3 mr-2 gap-x-6 gap-y-3 ">
          ...
          <div>
            <label className="label">
              <span className="label-text label-font">Nick Name</span>
            </label>
            <input
              type="text"
              name="nick_name"
          ...
          <div>
            <label className="label">
              <span className="label-text label-font">SSN</span>
            </label>
            <input
              type="text"
              name="ssn"
          ...
          <div>
            <label className="label">
              <span className="label-text label-font">Title</span>
            </label>
            <input
              type="text"
              name="title"
          ...
          <div>
            <label className="label">
              <span className="label-text label-font">Credential Type</span>
            </label>
            <select
          ...
          <div>
            <label className="label">
              <span className="label-text label-font">Individual NPI</span>
            </label>
            <input
              type="text"
              name="npi"
          ...
          <div>
            <label className="label">
              <span className="label-text label-font">CAQH Id</span>
            </label>
            <input
              type="text"
              name="caqh_id"
          ...
          <div>
            <label className="label">
              <span className="label-text label-font">Service Area Zip</span>
            </label>
            <input
              type="text"
              name="zip"
          ...
          <div>
            <label className="label">
              <span className="label-text label-font">Termination Date</span>
            </label>
            <input
              className="input-border text-gray-600 rounded-sm text-[14px]  font-medium w-full focus:outline-none"
              type="date"
          ...
          <div>
            <label className="label">
              <span className="label-text label-font">Language(s)</span>
            </label>
            <input
              type="text"
              name="language"
          ...
          <div>
            <label className="label">
              <span className="label-text label-font">Taxonomy Code</span>
            </label>
            <input
              type="text"
              name="taxonomy_code"
          ...
          <div className="sm:col-span-2">
            <label className="label">
              <span className="label-text label-font">Notes</span>
            </label>
