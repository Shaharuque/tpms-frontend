    ...
    <div className="app-body">
      <FullScreen handle={handle}>
        <Routes>
          ...
          <Route path="/form-demo-json" element={<JsonToHtml></JsonToHtml>}></Route>
          <Route path="/form-template" element={<FormTemplate1></FormTemplate1>}></Route>
          <Route path="/form-direct-service" element={<DirectService></DirectService>}></Route>
          <Route path="/Parent-training-session" element={<ParentTrainingSession></ParentTrainingSession>}></Route>
          <Route path="/BCBA-trainee" element={<BCBATrainee></BCBATrainee>}></Route>
          <Route path="/private-client" element={<PrivateClient></PrivateClient>}></Route>
          <Route path="/outpatient-treatment-request" element={<OutpatientTreatmentRequest></OutpatientTreatmentRequest>}></Route>
          <Route path="/clinic-treatment" element={<ClinicTreatment></ClinicTreatment>}></Route>
          <Route path="/FBA" element={<FBA></FBA>}></Route>
          <Route path="/BCBATraineeUSF" element={<BCBATraineeUSR></BCBATraineeUSR>}></Route>
          <Route path="/MonthlySupervisionNote" element={<MonthlySupervisionNote></MonthlySupervisionNote>}></Route>
          <Route path="/DiagnosisSessionForm" element={<DiagnosisSessionForm></DiagnosisSessionForm>}></Route>
          <Route path="/DischargeSummary" element={<DischargeSummary></DischargeSummary>}></Route>
          <Route path="/TreatmentPlanForm" element={<TreatmentPlanForm></TreatmentPlanForm>}></Route>
          <Route path="/Parent-treatment-from" element={<ParentTrainingForm></ParentTrainingForm>}></Route>
          <Route path="/assessment-form" element={<AssessmentForm></AssessmentForm>}></Route>
          <Route path="/behavior-analysis-progress-note" element={<BehaviorAnalysisProgressNote></BehaviorAnalysisProgressNote>}></Route>
          <Route path="/supervision-supervision" element={<SupervisionSupervision></SupervisionSupervision>}></Route>
          <Route path="/supervision-form" element={<SupervisionForm></SupervisionForm>}></Route>
          <Route path="/Service-Verification-log" element={<ServiceVerificationlog></ServiceVerificationlog>}></Route>
          <Route path="/Super-vision-Non-billable-Brct" element={<SupervisionNonbillableBrct></SupervisionNonbillableBrct>}></Route>
          <Route path="/cp-notes-form" element={<CPNotesForm></CPNotesForm>}></Route>
          <Route path="/clinical-form" element={<ClinicalForm></ClinicalForm>}></Route>
          <Route path="/smallsoap-form" element={<SmallSoap></SmallSoap>}></Route>
          <Route path="/session-notes" element={<SESSION_NOTES></SESSION_NOTES>}></Route>

          <Route path="/unique-supervision-form" element={<UniqueSupervisionForm></UniqueSupervisionForm>}></Route>
          <Route path="/management-modification-form" element={<ManagementModificationForm></ManagementModificationForm>}></Route>
          <Route path="/Supervision-Assessment" element={<SupervisionAssessment></SupervisionAssessment>}></Route>
          <Route path="/Structure-Of-Process" element={<StructureofProcess></StructureofProcess>}></Route>
          <Route path="/BIRPP-rogress-Form" element={<BIRPProgressForm></BIRPProgressForm>}></Route>
          <Route path="/cfars-form" element={<CFARS_Form></CFARS_Form>}></Route>
          <Route path="/discharge-summary" element={<DISCHARGE_SUMMEREY></DISCHARGE_SUMMEREY>}></Route>
          <Route path="/medication-flowsheet" element={<MEDICATION_FLOWSHEET></MEDICATION_FLOWSHEET>}></Route>
          <Route path="/no-show-progressnote" element={<NO_SHOW_PROGRESSNOTE></NO_SHOW_PROGRESSNOTE>}></Route>
          <Route path="/pcp-communication" element={<PCP_COMMUNICATION></PCP_COMMUNICATION>}></Route>
          <Route path="/locus-worksheet" element={<LOCUS_WORKSHEET></LOCUS_WORKSHEET>}></Route>
          <Route path="/relase-of-information" element={<RELEASE_OF_INFORMATION></RELEASE_OF_INFORMATION>}></Route>
          <Route path="/consent-to-treatment" element={<CONSENT_TO_TREATMENT></CONSENT_TO_TREATMENT>}></Route>
          <Route path="/fars-form" element={<FARS_FORM></FARS_FORM>}></Route>
          <Route path="/medication-consent" element={<MEDICATION_CONSENT></MEDICATION_CONSENT>}></Route>
          <Route path="/biopsycosocial" element={<BIOPSYCHOSOCIAL></BIOPSYCHOSOCIAL>}></Route>
          <Route path="/master-treatment-plan" element={<MASTER_TREATMENT_PLAN></MASTER_TREATMENT_PLAN>}></Route>
          <Route path="/biopsychosocial-assessment" element={<BIOPSYCHOSOCIAL_ASSESSMENT></BIOPSYCHOSOCIAL_ASSESSMENT>}></Route>
          <Route path="/new-two" element={<NEW_TWO></NEW_TWO>}></Route>
          <Route path="/speech-language-note" element={<SPEECH_LANGUAGE_SESSION_NOTE></SPEECH_LANGUAGE_SESSION_NOTE>}></Route>
          <Route path="/speech-language-progress-report" element={<SPEECH_LANGUAGE_PROGRESS_REPORT></SPEECH_LANGUAGE_PROGRESS_REPORT>}></Route>
          <Route
            path="/therapist-communication-session-notes"
            element={<THERAPIST_COMMUNICATION_SESSION_NOTES></THERAPIST_COMMUNICATION_SESSION_NOTES>}
          ></Route>
          <Route path="/treatment-plan" element={<TREATMENT_PLAN></TREATMENT_PLAN>}></Route>
          <Route path="/initial-speech-therapy-evaluation" element={<INITIAL_SPEECH_THERAPY_EVALUATION></INITIAL_SPEECH_THERAPY_EVALUATION>}></Route>
          <Route path="/daily-soap" element={<DailySoap></DailySoap>}></Route>
          <Route path="/new-form-new" element={<NewFromNew></NewFromNew>}></Route>
          <Route path="/Gs-Supervision-Form" element={<GssupervisionForm></GssupervisionForm>}></Route>
          <Route path="/Soap-Notes" element={<SoapNotes></SoapNotes>}></Route>
          <Route path="/CbhBehaviourAnalysisAssessment" element={<CBHbehaviourAssessmentForm></CBHbehaviourAssessmentForm>}></Route>
          <Route path="/data-sheet" element={<DataSheetForm></DataSheetForm>}></Route>
          <Route path="/locus-score-sheet" element={<LocusScoreSheetForm></LocusScoreSheetForm>}></Route>
          <Route path="/treatment-plan-form" re element={<TreatmentPlanReview></TreatmentPlanReview>}></Route>
          <Route path="/cbh-progress-note" element={<CBH_PROGRESS_NOTE></CBH_PROGRESS_NOTE>}></Route>
          <Route
            path="/cbh-medication-management-progress-note"
            element={<CBH_MEDICATION_MANAGEMENT_PROGRESS_NOTE></CBH_MEDICATION_MANAGEMENT_PROGRESS_NOTE>}
          ></Route>
          <Route
            path="/cbh-psychiatric-evaluation"
            element={<CBH_PSYCHIATRIC_EVALUATION_AND_MANAGEMENT_ASSESSMENT></CBH_PSYCHIATRIC_EVALUATION_AND_MANAGEMENT_ASSESSMENT>}
          ></Route>
          <Route path="/risk-assessment" element={<RiskAssessment></RiskAssessment>}></Route>
          <Route
            path="/cbh-psychiatric-evaluation-aba-only"
            element={<CBH_PSYCHIATRIC_EVALUATION_AND_MANAGEMENT_ASSESSMENT_ABAONLY></CBH_PSYCHIATRIC_EVALUATION_AND_MANAGEMENT_ASSESSMENT_ABAONLY>}
          ></Route>
          <Route path="/speech-language-session-notes" element={<SpeechLanguageSessionNotes></SpeechLanguageSessionNotes>}></Route>
          <Route path="/diagnosis-form" element={<DiagnosisForm></DiagnosisForm>}></Route>
          <Route path="/speech-language-progressss-report" element={<SpeechLanguageProgressReport></SpeechLanguageProgressReport>}></Route>

          <Route path="/ot-progressss-report" element={<OtProgressReport></OtProgressReport>}></Route>
          <Route path="/occupational-therapy-session-notes" element={<OccupationalTherapyNotes></OccupationalTherapyNotes>}></Route>
          <Route path="/physical-therapy-notes" element={<PhysicalTherapyNotes></PhysicalTherapyNotes>}></Route>
          <Route path="/ot-session-notes" element={<OtSessionForm></OtSessionForm>}></Route>
          <Route path="/pt-session-notes" element={<PtSessionForm></PtSessionForm>}></Route>
          <Route path="/aba-informed" element={<ABAInformed></ABAInformed>}></Route>
          <Route path="/aba-evaluation-parental-consent" element={<ABAEvaluationParentalConsent></ABAEvaluationParentalConsent>}></Route>
          <Route path="/aba-evaluation" element={<ABAEvaluation></ABAEvaluation>}></Route>
          <Route path="/ABA-Evalution-Fee-Document" element={<ABAEvalutionFeeDocument></ABAEvalutionFeeDocument>}></Route>
          <Route
          ...
          ></Route>
          <Route path="/Counseling-Supervision" element={<CounselingSupervision></CounselingSupervision>}></Route>
          <Route path="/Credit-Card_Authorization" element={<CreditCard_Authorization></CreditCard_Authorization>}></Route>
          <Route path="/Evaluation_consent_of_caregivers" element={<Evaluation_consent_of_caregivers></Evaluation_consent_of_caregivers>}></Route>
          <Route path="/My-Client-Rights" element={<MyClientRights></MyClientRights>}></Route>
          <Route path="/Parent-Assessment-Preparation-Memo" element={<ParentAssessmentPreparationMemo></ParentAssessmentPreparationMemo>}></Route>
          <Route path="/Parent-Consent" element={<ParentConsent></ParentConsent>}></Route>
          <Route path="/Parent-Evaluation-Preparation-Memo" element={<ParentEvaluationPreparationMemo></ParentEvaluationPreparationMemo>}></Route>
          <Route path="/SBH-Covid19-Policies" element={<SBHCovid19Policies></SBHCovid19Policies>}></Route>
          <Route path="/SBH-notice-privacy-practices" element={<SBH_notice_privacy_practices></SBH_notice_privacy_practices>}></Route>
          <Route path="/SBH-aba-consent" element={<SBHABAConsentForm></SBHABAConsentForm>}></Route>
          <Route path="/Informed-Consent-For-Teletherapy" element={<InformedConsentForTeletherapy></InformedConsentForTeletherapy>}></Route>
          <Route path="/Releaseof-Info-rmation-Consent" element={<ReleaseofInformationConsent></ReleaseofInformationConsent>}></Route>
          <Route path="/Evaluation-Services-Consent" element={<EvaluationServicesConsent></EvaluationServicesConsent>}></Route>

          <Route path="/ABA-Child-Intake" element={<ABAChildIntake></ABAChildIntake>}></Route>
          <Route path="/evaluation-intake-form" element={<Evaluation_intake_form></Evaluation_intake_form>}></Route>
          {/* ------------------------form End--------------------------- */}
          <Route path="/forget-password" element={<ForgetPassword></ForgetPassword>}></Route>
          <Route path="/code-check" element={<ForgetPasswordCodeCheck></ForgetPasswordCodeCheck>}></Route>
          <Route path="/new-password" element={<NewPassSet></NewPassSet>}></Route>
          ...
          <Route path="/details/:id" element={<SingleDetails></SingleDetails>}></Route>
          <Route path="/testing" element={<EditableCell></EditableCell>}></Route>
          <Route path="/search-box" element={<AntTableSearchBox></AntTableSearchBox>}></Route>
          ...
          <Route path="/super-admin" element={<SuperAdmin></SuperAdmin>}>
            ...
            <Route path="provider-access" element={<ProviderAccess></ProviderAccess>}>
              ...
              <Route path="delete-user" element={<DeleteUser></DeleteUser>}></Route>
              <Route path="unlock-user" element={<UnlockUser></UnlockUser>}></Route>
              <Route path="switch-user" element={<SwitchUser></SwitchUser>}></Route>
            </Route>
            <Route path="admin-access" element={<AdminAccess></AdminAccess>}>
              <Route index element={<Navigate to="page-access" />} />
              <Route path="page-access" element={<PageAccess></PageAccess>}></Route>
              <Route path="admin-create-user" element={<AdminCreateUser></AdminCreateUser>}></Route>
              <Route path="admin-delete-user" element={<AdminDeleteUser></AdminDeleteUser>}></Route>
              <Route path="admin-unlock-user" element={<AdminUnlockUser></AdminUnlockUser>}></Route>
              <Route path="admin-switch-user" element={<AdminSwitchUser></AdminSwitchUser>}></Route>
            </Route>
            <Route path="payor" element={<Payor></Payor>}></Route>
            <Route path="Companies-and-facilities" element={<CompaniesAndFacilities></CompaniesAndFacilities>}></Route>
            <Route path="company-level-CSV-Report" element={<CompanyLevelCSVReport></CompanyLevelCSVReport>}></Route>
            <Route path="user-page-permission" element={<UserPagePermission></UserPagePermission>}></Route>
            <Route path="Add-views-to-the-facility" element={<AddViewstothefacility></AddViewstothefacility>}></Route>
            <Route path="manage-credential" element={<ManageCredential></ManageCredential>}></Route>
            <Route path="bulk-upload" element={<BulkUpload></BulkUpload>}></Route>
            <Route path="billerlog-user" element={<BillerlogUser></BillerlogUser>}></Route>
            <Route path="All-accounts-report-execution" element={<AllAccountsReportExecution></AllAccountsReportExecution>}></Route>
            <Route path="duplicate-manage-claims-report" element={<DuplicateManageClaimsReport></DuplicateManageClaimsReport>}></Route>
            <Route
              path="missing-billed-sessions-under-appointment"
              element={<MissingBilledSessionsUnderAppointment></MissingBilledSessionsUnderAppointment>}
            ></Route>
            <Route path="create-deposit-apply-with-no-check" element={<CreateDepositApplyWithNoCheck></CreateDepositApplyWithNoCheck>}></Route>
            <Route path="insurance-details" element={<InsuranceDetails></InsuranceDetails>}></Route>
            <Route path="sms-email-settings" element={<SMSEmailSettings></SMSEmailSettings>}></Route>
            <Route path="blocked-admins-settings" element={<BlockUnblockAdmins></BlockUnblockAdmins>}></Route>
          </Route>
          ...
          >
            <Route path="report-export-view" element={<DownloadView></DownloadView>}></Route>
            ...
            <Route path="profile" element={<Profile></Profile>}>
              <Route path="profile-information" element={<ProfileInformation></ProfileInformation>}></Route>
              <Route path="password-change" element={<PasswordChange></PasswordChange>}></Route>
            </Route>
            ...
            {/* DASHBOARD ROUTES  */}
            {/* todays task  */}
            <Route path="billing/ar-followup-bucket" element={<ArFollowupBucket></ArFollowupBucket>}></Route>
            {/* <Route
              path="billing/ar-followup-bucket-filter-types/1"
              element={<ProvideEscalation></ProvideEscalation>} 
            ></Route> */}
            <Route path="billing/ar-followup-bucket-filter-types/1" element={<ArFollowupBucket></ArFollowupBucket>}></Route>
            <Route
            ...
            ></Route>
            {/* Patients  */}
            <Route path="auth-to-expire" element={<ExpiringAuthorization></ExpiringAuthorization>}></Route>
            <Route path="non-payor-tag" element={<SelfPayClients></SelfPayClients>}></Route>
            <Route path="no-authorization" element={<AuthorizationNotRequired></AuthorizationNotRequired>}></Route>
            <Route path="todays-copay" element={<CoPayForToday></CoPayForToday>}></Route>
            <Route path="auth-place-holder" element={<AuthPlaceHolders></AuthPlaceHolders>}></Route>
            {/* Staffs  */}
            <Route path="vacation-pending" element={<VacationPendingApproval></VacationPendingApproval>}></Route>
            <Route path="missing-credentials" element={<MissingCredentials></MissingCredentials>}></Route>
            <Route path="credentials-expire" element={<CredentialsToExpire></CredentialsToExpire>}></Route>
            <Route path="signature-not-update" element={<SignatureNotLoaded></SignatureNotLoaded>}></Route>
            {/* Billing  */}
            <Route path="session-not-bulled" element={<SessionRendered></SessionRendered>}></Route>
            <Route path="last-week-deposit" element={<LastWeeksDeposits></LastWeeksDeposits>}></Route>
            <Route path="last-five-statement" element={<LastMonthsStatements></LastMonthsStatements>}></Route>
            <Route path="last-month-billed-dated" element={<LastMonthBilledDates></LastMonthBilledDates>}></Route>
            <Route path="pending-secondary" element={<PendingSecondaryClaims></PendingSecondaryClaims>}></Route>
            {/* Scheduling  */}
            <Route path="scheduler-not-render" element={<Scheduled></Scheduled>}></Route>
            <Route path="schedule-not-attend-last-week" element={<Sessions></Sessions>}></Route>
            <Route path="provider-signature-missing-session" element={<Provider></Provider>}></Route>
            <Route path="session-note-missing" element={<SessionNote></SessionNote>}></Route>
            <Route path="cancelled-session" element={<CancelledSession></CancelledSession>}></Route>
            {/* Trending Reports  */}
            <Route path="sessions-manage" element={<ListView></ListView>}></Route>
            <Route path="m-remittance" element={<PaymentDeposits></PaymentDeposits>}></Route>
            <Route path="kpi-reported-by-months-view" element={<KPIReports></KPIReports>}></Route>
            <Route path="kpi-reported-by-patient-view" element={<KPIReportsPatient></KPIReportsPatient>}></Route>
            <Route path="kpi-reported-by-insurance-view" element={<KPIReportsInsurance></KPIReportsInsurance>}></Route>
            {/* ------------------------------  */}
            <Route path="deposit-apply/:id" element={<ApplyPayment></ApplyPayment>}></Route>
            <Route path="deposit-edit/:id" element={<EditDeposit></EditDeposit>}></Route>
            <Route path="deposit-details/:id" element={<DepositDetails></DepositDetails>}></Route>
            <Route path="deposit-add" element={<AddDeposit></AddDeposit>}></Route>

            {/* ----------------------------------DashBoard End----------------------------------------------- */}
            {/* APPOINTMENT ROUTES */}
            <Route path="session-manage" element={<ListView></ListView>}></Route>
            <Route path="calender-view" element={<CalendarView></CalendarView>}></Route>
            <Route path="recurring-session" element={<RecurringSession></RecurringSession>}></Route>
            <Route path="recurring-session-edit/:id" element={<RecurringSessionEdit></RecurringSessionEdit>}></Route>
            {/* ----------------------------------Appointment End----------------------------------------------- */}
            {/* PATIENT  */}
            ...
            <Route path="patient" element={<PatientsInfo></PatientsInfo>}>
              ...
              <Route path="patient-info/:id" element={<PatientInformation></PatientInformation>}></Route>
              <Route path="patient-authorization/:id" element={<Authorization></Authorization>}></Route>
              ...
              <Route path="patient-document/:id" element={<Documents></Documents>}></Route>
              <Route path="patient-portal/:id" element={<PatientPortal></PatientPortal>}></Route>
            ...
            <Route path="create-staff/provider" element={<CreateStaff></CreateStaff>}></Route>
            <Route path="create-staff/officeStaff" element={<OfficeStaff></OfficeStaff>}></Route>
            <Route path="staff" element={<StaffInformation></StaffInformation>}>
              <Route path="staffs-biographic/:id" element={<Bio></Bio>}></Route>
              <Route path="staffs-contact-details/:id" element={<ContactDetails></ContactDetails>}></Route>
              <Route path="staffs-credentials/:id" element={<Credentials></Credentials>}></Route>
              <Route path="staffs-department/:id" element={<DepartmentSupervisor></DepartmentSupervisor>}></Route>
              <Route path="staffs-payroll/:id" element={<PayrollSetup></PayrollSetup>}></Route>
              <Route path="staffs-other-setup/:id" element={<OtherSetup></OtherSetup>}></Route>
              <Route path="staffs-leave-tracking/:id" element={<LeaveTracking></LeaveTracking>}></Route>
              <Route path="staffs-payor-exclusion/:id" element={<InsuranceExclusion></InsuranceExclusion>}></Route>
              <Route path="staffs-sub-activity-exclusion/:id" element={<ServiceSubTypeExclusions></ServiceSubTypeExclusions>}></Route>
              <Route path="staffs-client-exclusion/:id" element={<PatientExclusion></PatientExclusion>}></Route>
              <Route path="staffs-portal/:id" element={<StaffPortal></StaffPortal>}></Route>
              <Route path="work-schedule/:id" element={<WorkSchedule></WorkSchedule>}></Route>
            </Route>
            {/* ----------------------------------Staff End----------------------------------------------- */}
            {/* BILLING  */}

            <Route path="submit-billing" element={<BillingManager></BillingManager>}>
            ...
            <Route path="submit-secondary-billing" element={<SecBillingManager></SecBillingManager>}>
              <Route index element={<Navigate to="pending-secondary-Claims" />} />
              <Route path="pending-secondary-Claims" element={<PendingSecondaryClaim></PendingSecondaryClaim>}></Route>
              <Route path="manage-secondary-claims" element={<ManageSecondaryClaims></ManageSecondaryClaims>}></Route>
            </Route>
            <Route path="ar-leader" element={<ArLedger></ArLedger>}>
              <Route index element={<Navigate to="ar-leader-claim-wish" />} />
              <Route path="ar-leader-claim-wish" element={<ClaimWise></ClaimWise>}></Route>
              <Route path="ar-leader-session-wish" element={<SessionWise></SessionWise>}></Route>
            </Route>
            <Route path="contract-rate" element={<ContractRate></ContractRate>}></Route>
            <Route path="billing/rate-list-add" element={<ContractRateAdd></ContractRateAdd>}></Route>
            <Route path="billing/rate-list-add-edit/:id" element={<ContractRateEditAdd></ContractRateEditAdd>}></Route>
            <Route path="patient-statement" element={<PatientStatement></PatientStatement>}></Route>
            <Route path="patient-eligibility" element={<Eligibility></Eligibility>}></Route>
            {/* ----------------------------------Billing End----------------------------------------------- */}
            {/* PAYMENT */}
            <Route path="era-remittance" element={<ERemittance></ERemittance>}></Route>
            <Route path="m-posting" element={<MPosting></MPosting>}></Route>
            <Route path="billing/deposit-apply/:id" element={<MDepositApply></MDepositApply>}></Route>
            <Route path="billing/deposit-add/:id" element={<MPostingEditAdd></MPostingEditAdd>}></Route>
            <Route path="billing/deposit-add" element={<MPostingEditAdd></MPostingEditAdd>}></Route>

            {/* ----------------------------------PAYMENT End----------------------------------------------- */}
            {/* PAYROLL  */}
            <Route path="processing-payroll" element={<ProcessingPayroll></ProcessingPayroll>}>
              <Route index element={<Navigate to="process-payroll" />} />
              <Route path="process-payroll" element={<Processing_Payroll />}></Route>
              <Route path="submit-payroll" element={<PayrollSubmission />}></Route>
              <Route path="completed-payroll" element={<ProcessedPayroll />}></Route>
            </Route>
            ...
            {/* ----------------------------------Report End----------------------------------------------- */}
            {/* settings routes  */}
            <Route path="form-builder-create" element={<FormBuilderCreate></FormBuilderCreate>}></Route>
            <Route path="settings" element={<Settings></Settings>}>
              <Route index element={<NameLocation></NameLocation>}></Route>
              <Route path="add-insurance" element={<AddInsurance></AddInsurance>}></Route>
              <Route path="insurance-setup" element={<InsuranceSetup></InsuranceSetup>}></Route>
              <Route path="add-treatment" element={<AddTreatments></AddTreatments>}></Route>
              <Route path="services" element={<AddServices></AddServices>}></Route>
              <Route path="cpt-code" element={<AddCptCode></AddCptCode>}></Route>
              <Route path="cpt-code-exclusion" element={<CptCodeExclusion></CptCodeExclusion>}></Route>
              <Route path="sub-activity-setup" element={<AddServiceSubType></AddServiceSubType>}>
              ...
              <Route path="add-staff-type" element={<AddStaffType></AddStaffType>}></Route>
              <Route path="rendering-provider" element={<ReferringProvider></ReferringProvider>}></Route>
              <Route path="pos" element={<PlaceOfServices></PlaceOfServices>}></Route>
              <Route path="vendor-number" element={<VendorNumberSetup></VendorNumberSetup>}></Route>
              <Route path="holiday-setup" element={<HolidaySetup></HolidaySetup>}></Route>
              <Route path="pay-period" element={<PayPeriod></PayPeriod>}></Route>
              <Route path="logo" element={<Logo></Logo>}></Route>
              <Route path="unbillable-activity" element={<UnbillableActivity></UnbillableActivity>}></Route>
              <Route path="unbillable-time-sheet" element={<UnBillableTimeSheet></UnBillableTimeSheet>}></Route>
              <Route path="session-rule" element={<CreateServiceRules></CreateServiceRules>}></Route>
              <Route path="file-manager" element={<EraManager></EraManager>}>
                ...
                <Route path="edi-status-files" element={<EDIStatusFiles></EDIStatusFiles>}></Route>
              </Route>
              <Route path="froms-builder" element={<FormsBuilder></FormsBuilder>}></Route>
              <Route path="notes-forms" element={<FormAndLibrary></FormAndLibrary>}></Route>
              <Route path="business-documents" element={<BusinessFiles></BusinessFiles>}></Route>
              <Route path="data-export" element={<DataImport></DataImport>}></Route>
              <Route path="meet-lists" element={<TpmsMeet></TpmsMeet>}></Route>
              <Route path="sms-email-setting" element={<EmailAndSms></EmailAndSms>}>
                <Route index element={<Navigate to="email-setting" />} />
                <Route path="email-setting" element={<EmailSetting></EmailSetting>}></Route>
                <Route path="sms-setting" element={<SmsSetting></SmsSetting>}></Route>
              </Route>
              <Route path="intake-form" element={<IntakeForm></IntakeForm>}></Route>
              <Route path="structure-of-process" element={<StructureOfProcess></StructureOfProcess>}></Route>
              <Route path="app-id-tracking" element={<AppIdTracking></AppIdTracking>}></Route>
              <Route path="create-program" element={<AddAllProgram></AddAllProgram>}></Route>
              <Route path="edit-program/:id" element={<EditAllProgram></EditAllProgram>}></Route>
              <Route path="program" element={<Program></Program>}>
                <Route index element={<Navigate to="account-type" />} />
                <Route path="account-type" element={<AccountType></AccountType>}></Route>
                <Route path="all-program" element={<AllPrograms></AllPrograms>}></Route>
                <Route path="program-category" element={<ProgramCategory></ProgramCategory>}></Route>
